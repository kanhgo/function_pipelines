...
- Use of an LLM (DistilBart) to summarize the extracted transcripts.
- Use of other AI tools (GPTs) (Gemini, ChatGPT) to identify main themes or topics discussed using the summaries and to extract additional value from existing content e.g. case studies, tips and tricks.
